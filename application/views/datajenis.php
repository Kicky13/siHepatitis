...
<head>
    ...
    <title>Data Jenis Hepatitis - HEPASIS</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-8 page-title-wrapper">
                        ...
                        <h2 class="page-subtitle">Hepastitis Diagnosis</h2>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default widget">
                                <div class="panel-heading">
                                    ...
                                    <h3 class="panel-title">Data Jenis Penyakit</h3>
                                    <a href="<?php echo base_url ('index.php/datajenis/tambahjenis'); ?>"><button type="button" class="btn btn-primary">
                                        <div class="info">
                                ...
                                <div class="panel-body">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td><?php echo $item['id_jenispenyakit']; ?></td>
                                            <td><?php echo $item['jenis_penyakit']; ?></td>
                                            <td><?php echo $item['solusi']; ?></td>
                                            <td><?php echo $item['tindakan']; ?></td>
                                            <td><?php echo $item['pencegahan']; ?></td>
                                            <td><a href="<?php echo base_url('index.php/datajenis/editjenis/'.$item['id_jenispenyakit']); ?>"><button  class="btn btn-success2" data-toggle="modal" data-target="#editGejala" class="btn ink-reaction btn-xl btn-floating-action btn-info">
                                                <div class="info">
                                                ...
                                                <p class="margin-10"></p>
                                                <a href="<?php echo base_url('index.php/datajenis/delete/'.$item['id_jenispenyakit']); ?>"><button type="button" class="btn btn-warning2">
                                                    <div class="info">
