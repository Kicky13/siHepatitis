...
<head>
    ...
    <title>Edit Gabungan - HEPASIS</title>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default widget">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Edit Data Gabungan</h3>
                                </div>
                                <div class="panel-body">
                                    <form class="form-horizontal style-form" method="post" action="<?php echo base_url('index.php/datagabungan/editdatagabungan/'.$data[0]['id_gabungan']); ?>">
                                            ...
                                            <div class="col-md-4">
                                                <select name="jenis_penyakit" class="select2">
                                                    <?php foreach ($jenis as $row){ ?>
                                                        <option value="<?php echo $row['id_jenispenyakit']; ?>" <?php echo ($row['id_jenispenyakit'] == $data[0]['id_jenispenyakit']) ? "selected":""; ?> ><?php echo $row['jenis_penyakit']; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4">
                                                <select name="gejala" class="select2">
                                                    <?php foreach ($gejala as $row){ ?>
                                                        <option value="<?php echo $row['id_gejala']; ?>" <?php echo ($row['id_gejala'] == $data[0]['id_gejala']) ? "selected":""; ?> ><?php echo $row['gejala']; ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
...
<!--                                            <label class="col-sm-2 col-sm-2 control-label">Nilai MB</label>-->
<!--                                            <div class="col-sm-10">-->
<!--                                                <input type="text" class="form-control round-form" placeholder="nilai MB" name="nilai_mb" value="--><?php //echo $data[0]['nilai_mb']; ?><!--" required>-->
<!--                                            </div>-->
<!--                                        </div>-->
<!--                                        <div class="form-group">-->
<!--                                            <label class="col-sm-2 col-sm-2 control-label">Nilai MD</label>-->
<!--                                            <div class="col-sm-10">-->
<!--                                                <input type="text" class="form-control round-form" placeholder="nilai MD" name="nilai_md" value="--><?php //echo $data[0]['nilai_md']; ?><!--" required>-->
<!--                                            </div>-->
<!--                                        </div>-->
