...
<head>
    ...
    <title>Konsultasi - HEPASIS</title>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default widget">
                                <div class="panel-heading">
                                    ...
                                    <!-- <a href="tambahgejala.html"><button type="button" class="btn btn-primary">
                                        <div class="info">
                                ...
                                <div class="panel-body">
                                    <form method="post" action="<?php echo base_url('index.php/konsultasi/hasilDiagnosis'); ?>">
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th>No</th>
                                        ...
                                        <tr>
                                            ...
                                            <td><div class="panel-body">
                                                    <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" name="gejala[]" value="<?php echo $item['id_gejala']; ?>">
                                                    </label>
                                                    </div>
                                                    </div></td>
                                        </tr>
                                    ...
                                    <div class="card-body" >
                                        <button type="submit" class="btn btn-primary" value="diagnosis">
                                        <div class="info">
                                            <label><i class="icon fa fa-paper-plan" aria-hidden="true">Diagnosis</i>
                                            </label>
                                        </div>
                                        </button>
                                    </div>
