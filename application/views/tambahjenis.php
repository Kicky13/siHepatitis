...
<head>
    ...
    <title>Tambah Jenis Penyakit - HEPASIS</title>
            ...
            <div class="container-fluid">
                ...
                <div id="page-content">
                  ...
                  <div class="panel-heading">
                    <h3 class="panel-title">Tambah Data Jenis Penyakit</h3>
                  </div>
                  <div class="panel-body">
                    <form class="form-horizontal style-form" method="post" action="<?php echo base_url('index.php/datajenis/submitdatajenis'); ?>">
<!--                      <div class="form-group">-->
<!--                        <label class="col-sm-2 col-sm-2 control-label">ID Jenis Penyakit</label>-->
<!--                        <div class="col-sm-10">-->
...
<!--                      </div>-->
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control round-form" placeholder="jenis penyakit" name="jenis_penyakit" required>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Solusi</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control round-form" placeholder="solusi" name="solusi" required>
                        </div>
                      </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Tindakan Dokter</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control round-form" placeholder="tindakan" name="tindakan" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Pencegahan</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control round-form" placeholder="pencegahan" name="pencegahan" required>
                            </div>
                        </div>
