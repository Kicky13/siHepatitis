...
<head>
    ...
    <title>Data Gejala - HEPASIS</title>
    ...
    <!-- Vendor -->
    <link href="<?php echo base_url().'public/'; ?><?php echo base_url().'public/'; ?><?php echo base_url().'public/'; ?>assets/vendor/md-snackbars/md-snackbars.min.css" rel="stylesheet">
    <link href="<?php echo base_url().'public/'; ?><?php echo base_url().'public/'; ?>assets/vendor/zabuto/zabuto_calendar.min.css" rel="stylesheet">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default widget">
                                <div class="panel-heading">
                                    ...
                                    <h3 class="panel-title">Data Gejala</h3>
                                    <a href="<?php echo base_url ('index.php/datagejala/tambahgejala'); ?>"><button type="button" class="btn btn-primary">
                                        <div class="info">
                                            <label><i>Tambah</i></label>
                                        </div>
                                    </button>
                                    </a>
                                </div>
                                <div class="panel-body">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td><?php echo $item['id_gejala']; ?></td>
                                            <td><?php echo $item['gejala']; ?></td>
                                            <td><a href="<?php echo base_url('index.php/datagejala/editgejala/'.$item['id_gejala']); ?>"><button  class="btn btn-success2" data-toggle="modal" data-target="#editGejala" class="btn ink-reaction btn-xl btn-floating-action btn-info">
                                                <div class="info">
                                                    <i class="icon fa fa-pencil" aria-hidden="true"></i>
                                                </div></button></a>
                                                <p class="margin-10"></p>
                                                <a href="<?php echo base_url('index.php/datagejala/delete/'.$item['id_gejala']); ?>"><button type="button" class="btn btn-warning2">
                                                    <div class="info">
