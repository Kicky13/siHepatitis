...
<head>
    ...
    <title>Data Gabungan - HEPASIS</title>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default widget">
                                <div class="panel-heading">
                                    ...
                                    <a href="<?php echo base_url ('index.php/datagabungan/tambahgabungan'); ?>"><button type="button" class="btn btn-primary">
                                        <div class="info">
                                ...
                                <div class="panel-body">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td><?php echo $item['id_gabungan']; ?></td>
                                            <td><?php echo $item['id_jenispenyakit']; ?></td>
                                            <td><?php echo $item['id_gejala']; ?></td>
                                            <td><?php echo $item['nilai_mb']; ?></td>
                                            <td><?php echo $item['nilai_md']; ?></td>
                                            <td><?php echo $item['nilai_cf']; ?></td>
                                            <td><a href="<?php echo base_url ('index.php/datagabungan/editgabungan/'.$item['id_gabungan']); ?>"><button  class="btn btn-success2" data-toggle="modal" data-target="#editGejala" class="btn ink-reaction btn-xl btn-floating-action btn-info">
                                                <div class="info">
                                                ...
                                                <p class="margin-10"></p>
                                                <a href="<?php echo base_url('index.php/datagabungan/delete/'.$item['id_gabungan']); ?>"><button type="button" class="btn btn-warning2">
                                                    <div class="info">
