...
<head>
    ...
    <title>Edit Jenis Penyakit - HEPASIS</title>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default widget">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Edit Data Jenis Penyakit</h3>
                                </div>
                                <div class="panel-body">
                                    <form class="form-horizontal style-form" method="post" action="<?php echo base_url('index.php/datajenis/editdatajenis/'.$data[0]['id_jenispenyakit']); ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control round-form" placeholder="jenis_penyakit" name="jenis_penyakit" value="<?php echo $data[0]['jenis_penyakit']; ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Solusi</label>
                                            <div class="col-sm-10">
                                                <textarea class="form-control round-form" placeholder="solusi" name="solusi" required><?php echo $data[0]['solusi']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Tindakan Dokter</label>
                                            <div class="col-sm-10">
                                                <textarea class="form-control round-form" placeholder="tindakan" name="tindakan" required><?php echo $data[0]['tindakan']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Pencegahan</label>
                                            <div class="col-sm-10">
                                                <textarea class="form-control round-form" placeholder="pencegahan" name="pencegahan" required><?php echo $data[0]['pencegahan']; ?></textarea>
                                            </div>
                                        </div>

                                        <div class="col-sm-8 col-sm-offset-2">
                                            <button class="btn-success btn" name="edit" value="edit">Simpan</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
