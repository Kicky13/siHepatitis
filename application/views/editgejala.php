...
<head>
    ...
    <title>Edit Gejala - HEPASIS</title>
            ...
            <div class="container-fluid">
                <div id="page-sidebar" class="toggled sidebar">
                    ...
                    <ul class="nav nav-pills nav-stacked" id="sidebar-stacked">
                        ...
                        <li class="active">
                            <a href="<?php echo base_url ('index.php/datajenis'); ?>"><i class="fa fa-heartbeat"></i> <span class="nav-text">Data Jenis Hepatitis</span></a>
                        </li>
                        <li class="active">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default widget">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal style-form" method="post" action="<?php echo base_url('index.php/datagejala/editdata/'.$data[0]['id_gejala']); ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control round-form" placeholder="gejala" name="gejala" value="<?php echo $data[0]['gejala']; ?>" required>
                                            </div>
                                        </div>
