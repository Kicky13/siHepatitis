...
<!-- Mirrored from paullaros.nl/spark-1-1/bootstrap3/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2017 20:03:16 GMT -->
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-8 page-title-wrapper">
              ...
              <h2 class="page-subtitle2">Dashboard</h2>
            </div>
              ...
              <div class="col-md-6">
                <div class="panel panel-default widget">
                  <div class="panel-heading">
                    ...
                    <!--<h3 class="panel-title">Images Shapes</h3>-->
                  </div>
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-md-10">
                        <img src="<?php echo base_url().'public/'; ?>assets/img/hepa.jpg" class="img-responsive" />
                        <p class="margin-10"></p>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-md-6">
                <div class="panel panel-default widget">
                  <div class="panel-heading">
                    ...
                    <!--<h3 class="panel-title">Images Sizes</h3>-->
                  </div>
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-md-10">
                        <img src="<?php echo base_url().'public/'; ?>assets/img/b.jpg" class="img-responsive" />
                        <p class="margin-10"></p>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-md-6">
                <div class="panel panel-default widget">
                  <div class="panel-heading">
                    ...
                    <!--<h3 class="panel-title">Images Responsive</h3>-->
                  </div>
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-md-10">
                        <img src="<?php echo base_url().'public/'; ?>assets/img/viral-hepatitis.jpg" class="img-responsive" />
                        <p class="margin-10"></p>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-md-6">
                <div class="panel panel-default widget">
                  <div class="panel-heading">
                    ...
                    <!--<h3 class="panel-title">Images Thumbnails</h3>-->
                  </div>

                    <div class="panel-body">
                      <div class="row">
                        <div class="col-md-10">
                          <img src="<?php echo base_url().'public/'; ?>assets/img/a.jpg" class="img-responsive" />
                          <p class="margin-10"></p>
                        </div>
                      </div>
                    </div>
...
<!-- Mirrored from paullaros.nl/spark-1-1/bootstrap3/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2017 20:04:42 GMT -->
</html>
